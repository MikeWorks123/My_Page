    ...
    <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
                ...
                <h1 class="mb-0">I am Here to Help You Grow Your Business Exponentially</h1>
            </div>
            <div class="row g-5">
                <div class="col-lg-4">
                    <div class="row g-5">
                        <div class="col-12 wow zoomIn" data-wow-delay="0.2s">
                            ...
                            <h4>Team Player</h4>
                            <p class="mb-0">I am a dedicated team player who actively collaborates with others, contributing my skills and fostering a positive working environment to achieve shared objectives.</p>
                        </div>
                        <div class="col-12 wow zoomIn" data-wow-delay="0.6s">
                            ...
                            <h4>Initiative</h4>
                            <p class="mb-0">I am a proactive team player, always eager to take initiative, contribute new ideas, and demonstrate leadership to drive positive outcomes for the team and the organization.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4">
                    <div class="row g-5">
                        <div class="col-12 wow zoomIn" data-wow-delay="0.4s">
                            ...
                            <h4>Adaptability</h4>
                            <p class="mb-0">I exhibit a strong sense of adaptability and openness to change, enabling me to navigate diverse situations with ease and embrace new challenges with a positive and flexible mindset.</p>
                        </div>
                        <div class="col-12 wow zoomIn" data-wow-delay="0.8s">
                            ...
                            <h4>Analytic</h4>
                            <p class="mb-0">I am an analytical team player, leveraging a keen eye for detail and systematic thinking to assess situations, solve problems, and contribute to informed decision-making within the team.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row justify-content-end">
                <div class="col-lg-8 col-md-6">
                    <div class="d-flex align-items-center justify-content-center" style="height: 75px;">
                        <p class="mb-0">&copy; <a class="text-white border-bottom" href="#">My Portfolio</a>. All Rights Reserved. 
